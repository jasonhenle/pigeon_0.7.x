...
```bash
./Pigeon_0.8.0_Development/Pigeon/installer/ship_to_main.sh
```
...
```bash
./Pigeon_0.8.0_Development/Pigeon/installer/setup_desktop_launchers.sh
```
...
curl -s "https://raw.githubusercontent.com/jasonhenle/pigeon_0.7.x/main/Pigeon_0.8.0_Development/Pigeon/pigeonSystem/pigeon/version.py" | grep PATCH
```
