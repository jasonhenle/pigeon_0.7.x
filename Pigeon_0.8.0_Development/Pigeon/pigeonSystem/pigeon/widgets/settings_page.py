"""
Pigeon **legacy_settings** SVG page (``settings_0.7.svg``).

Retained until ``main_settings`` (``settings_main.svg`` / ``main_settings.py``) is
stable. Tab cycle: main_settings → legacy Tk settings → off. This module is the
SVG design sibling of the Tk legacy form — not the primary 0.8 menu.
"""
...
# Conceptual alias: this module is legacy_settings until main_settings is stable.
LegacySettingsPageState = SettingsPageState
