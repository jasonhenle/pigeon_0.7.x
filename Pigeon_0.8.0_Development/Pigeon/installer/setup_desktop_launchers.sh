...
EXPERIMENT_APP="${EXPERIMENT_ROOT}/Pigeon_0.8.0_Development/Pigeon"
MAIN_APP="${MAIN_ROOT}/Pigeon_0.8.0_Development/Pigeon"
...
if [[ ! -f "\${APP}/installer/run_pigeon_0_8.command" ]]; then
