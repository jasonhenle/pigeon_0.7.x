...
2. Unzip the archive.
3. Go to:  
   **`Pigeon_0.6.0_Development/Pigeon_0.6.0/`** inside the extracted folder.
...
cd pigeon_0.5/Pigeon_0.6.0_Development/Pigeon_0.6.0
...
| Location | Contents |
|----------|----------|
| App folder (e.g. `~/Pigeon_0.6.0`, `~/Applications/Pigeon_0.6.0`) | Code, launcher, venv, local TMDb cache folders |
...
- Refresh Python dependencies (`run_pigeon_0_6.sh --bootstrap-only`).
