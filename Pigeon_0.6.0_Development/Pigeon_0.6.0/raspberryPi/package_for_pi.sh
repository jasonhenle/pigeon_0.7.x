...
# Output: raspberryPi/dist/pigeon_0.6.0_raspberry_pi.tar.gz
set -euo pipefail
...
ARCHIVE_NAME="pigeon_0.6.0_raspberry_pi.tar.gz"
...
rsync -a \
  ...
  "${PIGEON_ROOT}/" "${STAGING}/Pigeon_0.6.0/"

mkdir -p \
  "${STAGING}/Pigeon_0.6.0/pigeonCashe" \
  "${STAGING}/Pigeon_0.6.0/pigeonTMDB/pigeonTMDB_BD" \
  "${STAGING}/Pigeon_0.6.0/pigeonTMDB/pigeonTMDB_ORIGINAL" \
  "${STAGING}/Pigeon_0.6.0/pigeonTMDB/pigeonTMDB_Poster" \
  "${STAGING}/Pigeon_0.6.0/pigeonTMDB/pigeonTMDB_TT"

chmod +x \
  "${STAGING}/Pigeon_0.6.0/run_pigeon_0_6.sh" \
  "${STAGING}/Pigeon_0.6.0/install_pigeon.sh" \
  "${STAGING}/Pigeon_0.6.0/run-pigeon.sh" \
  "${STAGING}/Pigeon_0.6.0/Install-Pigeon" \
  "${STAGING}/Pigeon_0.6.0/Run-Pigeon" \
  "${STAGING}/Pigeon_0.6.0/installer/click_install_pi.sh" \
  "${STAGING}/Pigeon_0.6.0/installer/click_run_pigeon_pi.sh" \
  "${STAGING}/Pigeon_0.6.0/raspberryPi/install_on_pi.sh"

echo "==> Writing ${DIST_DIR}/${ARCHIVE_NAME}"
tar -C "${STAGING}" -czf "${DIST_DIR}/${ARCHIVE_NAME}" Pigeon_0.6.0
...
echo "  Open the Pigeon_0.6.0 folder and double-click Install-Pigeon"
