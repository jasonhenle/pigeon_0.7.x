...
macOS default install dir:  ~/Applications/Pigeon_0.6.0
Linux / Pi default dir:   ~/Pigeon_0.6.0

After install, launch with:
  macOS:  ~/Desktop/Pigeon.command   (or run_pigeon_0_6.command in the install folder)
  Linux:  ./run_pigeon_0_6.sh        (in the install folder)
EOF
}
