...
This folder is the runnable/shareable build for Pigeon `0.6.0`.
...
- `run_pigeon_0_6.command`: launch script for this build.
...
- `testingEnvironments/`: local test scripts in `Pigeon_0.6.0_Development/testingEnvironments` (development-level folder).
