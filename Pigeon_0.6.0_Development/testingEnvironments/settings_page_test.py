...
From ``Pigeon_0.6.0_Development``::

    Pigeon_0.6.0/pigeonSystem/.venv/bin/python testingEnvironments/settings_page_test.py
...
def _ensure_pigeon_on_path() -> None:
    ...
    system = dev_root / "Pigeon_0.6.0" / "pigeonSystem"
    s = str(system)
