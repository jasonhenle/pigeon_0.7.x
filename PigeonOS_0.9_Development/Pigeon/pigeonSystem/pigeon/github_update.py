...
_BOOTSTRAP_SCRIPT_RAW = (
    ...
    "PigeonOS_0.9_Development/Pigeon/installer/pigeon_github_update.sh"
)
_LAUNCHER_NAMES = (
    ...
    *,
    ...
    try:
        ...
        return ApplyUpdateResult(
            ...
            '    "https://raw.githubusercontent.com/jasonhenle/pigeon_0.7.x/main/'
            'PigeonOS_0.9_Development/Pigeon/installer/install_from_github.sh"\n'
