...
Then go to **`PigeonOS_0.9_Development/Pigeon/`** inside the extracted folder and run the installer for your platform.

**Clone:**

```bash
git clone https://github.com/jasonhenle/pigeon_0.7.x.git
cd pigeon_0.7.x/PigeonOS_0.9_Development/Pigeon
