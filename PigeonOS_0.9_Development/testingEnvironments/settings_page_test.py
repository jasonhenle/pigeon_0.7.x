"""
Standalone preview for the Pigeon 0.8 settings page (SVG menu + arrow-key focus).

From ``PigeonOS_0.9_Development``::
...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(description="Preview the Pigeon 0.8 settings page SVG menu.")
    ap.add_argument(
        "--svg",
        type=Path,
        default=None,
